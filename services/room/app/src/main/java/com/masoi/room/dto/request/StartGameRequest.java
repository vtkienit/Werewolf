...
public final class StartGameRequest {
    private final String gameId;
    private final String playerName;
    private final com.masoi.room.model.RoleId roleId;

    public StartGameRequest(String gameId, String playerName, com.masoi.room.model.RoleId roleId) {
        this.gameId = gameId;
    ...
    public String toString() {
        return "StartGameRequest[REDACTED]";
    }
}
